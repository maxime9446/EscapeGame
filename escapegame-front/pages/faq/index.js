        ...
        <div>
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                    <h2 className="mb-8 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">La
                        faq</h2>
                    <div
                        className="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
                        <div>{faqs.data.map((faq) => (
                            <div className="mb-10" key={faq.id}>
                                ...
                                <p className="text-gray-500 dark:text-gray-400">{faq.attributes.answer}</p>
                            </div>
                        ))}
                        </div>
